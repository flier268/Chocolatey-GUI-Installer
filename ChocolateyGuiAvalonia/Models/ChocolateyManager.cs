...
public class ChocolateyManager
{
    ...
    public bool InstallChocolatey(Action<string> log)
    {
        try
        {
            ...
            var psi = new ProcessStartInfo
            {
                FileName = "powershell",
                Arguments =
                    "-NoProfile -ExecutionPolicy Bypass -Command \"Set-ExecutionPolicy Bypass -Scope Process -Force; [Net.ServicePointManager]::SecurityProtocol = [Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://community.chocolatey.org/install.ps1'))\"",
                RedirectStandardOutput = true,
    ...
    public Dictionary<string, (bool Installed, string Version)> GetInstalledPackages(
    ...
    )
    {
        ...
        try
        {
            ...
            {
                var found = lines.FirstOrDefault(l =>
